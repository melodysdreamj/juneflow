...
var paramListNewModel = [
  ...
  // ["L019", "text", "'[]'"],
  // ["L020", "text", "'[]'"],
  // ["C000", "text","'${(SomeModel().toString())}'"],
  // ["C001", "text","'${(SomeModel().toString())}'"],
  // ["C002", "text","'${(SomeModel().toString())}'"],
  // ["C003", "text","'${(SomeModel().toString())}'"],
  // ["C004", "text","'${(SomeModel().toString())}'"],
  // ["C005", "text","'${(SomeModel().toString())}'"],
  // ["C006", "text","'${(SomeModel().toString())}'"],
  // ["C007", "text","'${(SomeModel().toString())}'"],
  // ["C008", "text","'${(SomeModel().toString())}'"],
  // ["C009", "text","'${(SomeModel().toString())}'"],
  // ["C010", "text","'${(SomeModel().toString())}'"],
  // ["C011", "text","'${(SomeModel().toString())}'"],
  // ["C012", "text","'${(SomeModel().toString())}'"],
  // ["C013", "text","'${(SomeModel().toString())}'"],
  // ["C014", "text","'${(SomeModel().toString())}'"],
  // ["C015", "text","'${(SomeModel().toString())}'"],
  // ["C016", "text","'${(SomeModel().toString())}'"],
  // ["C017", "text","'${(SomeModel().toString())}'"],
  // ["C018", "text","'${(SomeModel().toString())}'"],
  // ["C019", "text","'${(SomeModel().toString())}'"],
  // ["C020", "text","'${(SomeModel().toString())}'"],
  // ["J000", "text","'[]'"],
  // ["J001", "text","'[]'"],
  // ["J002", "text","'[]'"],
  // ["J003", "text","'[]'"],
  ...
  // ["J019", "text","'[]'"],
  // ["J020", "text","'[]'"],
  // ["E000", "text","'NotSelected'"],
  // ["E001", "text","'NotSelected'"],
  // ["E002", "text","'NotSelected'"],
  // ["E003", "text","'NotSelected'"],
  // ["E004", "text","'NotSelected'"],
  // ["E005", "text","'NotSelected'"],
  // ["E006", "text","'NotSelected'"],
  // ["E007", "text","'NotSelected'"],
  // ["E008", "text","'NotSelected'"],
  // ["E009", "text","'NotSelected'"],
  // ["E010", "text","'NotSelected'"],
  // ["E011", "text","'NotSelected'"],
  // ["E012", "text","'NotSelected'"],
  // ["E013", "text","'NotSelected'"],
  // ["E014", "text","'NotSelected'"],
  // ["E015", "text","'NotSelected'"],
  // ["E016", "text","'NotSelected'"],
  // ["E017", "text","'NotSelected'"],
  // ["E018", "text","'NotSelected'"],
  // ["E019", "text","'NotSelected'"],
  // ["E020", "text","'NotSelected'"],
